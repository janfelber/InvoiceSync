...
public final class RegexPatterns {
  ...
  // Regular expression for vat number(IC DPH)
  public static final String VAT_NUMBER = "\\s?([A-Z]{2}\\s?\\d{8,12})";
  ...
  // Regular expression for tax number(DIC)
  public static final String TAX_NUMBER = "\\s?[A-Z0-9]{8,12}";
