...
CREATE TABLE invoice_sync.email_subscribe
(
  id             BIGSERIAL PRIMARY KEY,
  email          VARCHAR(255),
...
CREATE TABLE invoice_sync.invoice
(
  id                          BIGSERIAL PRIMARY KEY,
  company_id                  BIGINT,
  created_by                  VARCHAR(255) NOT NULL,
...
CREATE TABLE invoice_sync.subscriptions
(
  id                                BIGSERIAL PRIMARY KEY,
  created_by                        VARCHAR(255) NOT NULL,
  ...
  monthly_used_invoice_export_limit INT,
...
CREATE TABLE invoice_sync.xml_file
(
  id                 BIGSERIAL PRIMARY KEY,
  created_by         VARCHAR(255) NOT NULL,
  file_name          VARCHAR(255),
